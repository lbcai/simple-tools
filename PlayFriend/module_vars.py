hangman_vocab = [('Abdicate', 'to step down from a position of power'),
                 ...
                 ('Ossify', 'to become rigid, to become set in one’s ways'),
                 ...
                 ('Welter', 'to write, toss, wallow'), ('Winnow', 'to blow off, or away, to separate the good from the bad'),
